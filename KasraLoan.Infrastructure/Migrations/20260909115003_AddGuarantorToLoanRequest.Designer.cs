...
namespace KasraLoan.Infrastructure.Migrations
{
    ...
    [Migration("20260909115003_AddGuarantorToLoanRequest")]
    partial class AddGuarantorToLoanRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KasraLoan.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<List<string>>("AdditionalEmails")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("KasraLoan.Domain.Entities.LoanFund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KasraLoan.Domain.Entities.LoanRequest", b =>
                {
                    ...
                    b.Property<bool>("GuaranteeChequeAcknowledged")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("KasraLoan.Domain.Entities.LoanRequest", b =>
                {
                    ...
                    b.HasOne("KasraLoan.Domain.Entities.Employee", "Guarantor")
                        .WithMany()
